	...
	<main class="container">
		...
		<div class="con-mid text-inf">
			...
			<div class="dmsp">
				<ul class="dmsp-ul">
					<li class="dmsp-li">
					<a id="" href="<c:url value="/product?type=show&manufacturer=Adidas&page=1&maxPageItem=6&sortName=price&sortBy=desc"/>"
					...
					<li class="dmsp-li">
						<a href="<c:url value="/product?type=show&manufacturer=Nike&page=1&maxPageItem=6&sortName=price&sortBy=desc"/>" style="text-decoration: none;">
						<img
						...
						<c:forEach var="item" items="${spList}">
							<li>
								<div>
									...
									<a href="<c:url value="${detailURL}"/>"> <img
