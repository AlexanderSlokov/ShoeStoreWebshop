...
<body>
	...
	<main class="container">
		...
		<div class="con-mid text-inf">
			...
			<div class="dmsp">
				<ul class="dmsp-ul">
					<li class="dmsp-li"><c:url var="showURL"
							value="views/web/show_product.jsp">
							<c:param name="categoryId" value="ADIDIAS" />
						</c:url> <a id="" href="<c:url value="views/web/show_product.jsp"/>"
					...
					<li class="dmsp-li"><c:url var="showURL"
							value="views/web/show_product.jsp">
							<c:param name="categoryId" value="NIKE" />
						</c:url> <a href="" style="text-decoration: none;"> 
						<img
