...
<html>
    <head>
        ...
        <link rel="stylesheet" href="./assets/css/flogin.css">
        <!--font-->
        ...
        <main class="main_logiform">
            <div class="loginform">
                <div class="loginform__left ">
                    <img src="https://images.meesho.com/images/products/89867327/hh4s5_512.jpg" alt="logowed">
                ...
                <div class="loginform__right">
                    ...
                    <div id="for-register">                        
                        <div class="loginform__right-header text_left"><a>REGRISTER</a></div>                        
                        <div class="loginform__right-body">
                            <input class="inputregis" placeholder="Full name" name="uFullname" required>
                            <input class="inputregis" placeholder="Email" name="uEmail" required>
                            <input class="inputregis" placeholder="Phone number" name="uPhone" required>
                            <input class="inputregis" placeholder="Password" name="uPass" required>
                            <input class="inputregis" placeholder="Confirm password" name="uConfpass" required>
                            <input class="inputregis" placeholder="Address" name="uaddress" required>

                        


                            <button class="inputregis" style="color:red; " onclick="registerfun1()"> Register</button>
